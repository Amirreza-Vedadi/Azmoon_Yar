...
class ExamUI:
    def __init__(self):
        ...
        self.option_buttons = []
        for i in range(4):
            rb = Radiobutton(self.window, text="", variable=self.options_var, value="", bg="#2471a3", font=("B Koodak", 14))
    ...
    def display_question(self):
        ...
        self.time_left = int(question[7]) if not self.navigation_enabled else 0
